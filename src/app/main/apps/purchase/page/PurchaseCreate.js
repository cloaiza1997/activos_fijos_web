...
import { getHandleChange, roundNumber } from '@core/utils/utils';
...
// Components
import { PAYMENT_METHODS, PURCHASE_URL_CREATE } from '../PurchaseConst';
							...
							<tbody>
								{form.items.map((item, index) => (
									<tr key={index} className="border-b">
										...
										<td className="text-center">
											<IconButton size="small" onClick={() => onEditItem(item, index)}>
